 ...
 * last_update 2015-09-16 23:13 GMT+0800 CST
 */
...
// public static function bite(param1:String) : Object
	function bite(tvid, flash_tm) {
		...
		// NOTE start new Zombie here 2015-09-16
		...
		var_1["4a8a08f09d37b73795649038408b5f33"] = var_22;
		var_1["8277e0910d750195b448797616e091ad"] = var_25;
		...
		var_1["e1671797c52e15f763380b45e841ec32"] = var_30;
		var_1["8fa14cdd754f91cc6554c9e71929cce7"] = var_33;
		...
		while (var_6.length) {
			var_5(var_20,var_1[var_6.shift()]());
		}
		
		var var_35 = var_20.join('') + '7b11c5408ff342318da3e7c97b92e890';
		
		var var_36 = 0;
		while (var_36 < var_20.length) {
			// NOTE AObject and kcuf used here
			var_20[var_36] = var_2['seek']([kcuf[var_20[var_36]]()]);
			var_36 ++;
		}
		
		// NOTE set flash_tm here
		// var var_37:uint = getTimer();
		var var_37 = flash_tm;
		
		// NOTE get salt here
		var _tmp_salt = var_20.join('');
		
		// NOTE add flash_tm and tvid here
		var_5(var_20, var_37);
		var_5(var_20, var_4);
		
		// NOTE main md5 hash function here
		var var_38 = function (param1) {
		// NOTE end new Zombie at 2015-09-16
			var k = null;
			var name_2 = 0;
			var name_1 = param1;
			k = [];
		...
		// NOTE new Zombie start here at 2015-09-16
		var var_39 = {};
		// var var_40 = var_38(var_20.join(''));
		var _tmp_raw = var_20.join('');
		var var_40 = var_38(_tmp_raw);
