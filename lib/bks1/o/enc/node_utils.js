 ...
 * version 0.0.6.1 test201508202219
 */
...
// o/enc modules
var _Zombie = require('./js/Zombie.js');
// NOTE AObject may be no use
var _AObject = require('./js/AObject.js');

var _fix_kcuf = require('./js/fix_kcuf.js');

// for thd
var _dota = require('./js/MediaDota.js');
var _soldier = require('./js/Soldier.js');
...
// fix thd
	function fix_thd() {
		// create thd
		var d = new _dota.MediaDota();
		var thd = _soldier.get_thd(d);
		// just set it
		_Zombie.set_thd(thd);
	}
...
exports.fix_thd = fix_thd;	// fix_thd();
