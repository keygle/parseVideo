 ...
 * last_update 2015-07-09 22:12 GMT+0800 CST
 */
...
// public static function kcusu(param1:String) : Object
	function kcusu(tvid, flash_tm) {
		...
		// WARNING var_82 is not the standard md5_hash function
		var var_82 = function(param1) {
			...
			// NOTE debug here, try to find out the salt
			_tmp_salt2 = arrStr;
			
			arrStr = arrStr + name_10;
			
			// NOTE debug here, arrStr may be the raw string before md5_hash
			_tmp_arrstr = arrStr;
			
			return msg();
		};	// end function may be md5_hash
		
		// NOTE debug for arrStr, and salt
		var _tmp_arrstr = null;
		var _tmp_salt2 = null;
		...
		// NOTE add raw and arrstr string
		var_83.raw = _tmp_raw;
		var_83.salt = _tmp_salt;
		var_83.arrstr = _tmp_arrstr;
		var_83.salt2 = _tmp_salt2;
